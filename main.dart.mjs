...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1569: (x0,x1) => new WebSocket(x0,x1),
      _1570: (x0,x1) => x0.send(x1),
      _1571: (x0,x1,x2) => x0.close(x1,x2),
      _1573: x0 => x0.close(),
      _1593: (x0,x1) => x0.key(x1),
      _1594: (x0,x1) => x0.item(x1),
      _1595: x0 => x0.random(),
      _1596: (x0,x1) => x0.getRandomValues(x1),
      _1597: () => globalThis.crypto,
      _1598: () => globalThis.Math,
      _1601: (x0,x1) => x0.getContext(x1),
      ...
      _1795: (x0,x1) => { x0.oncancel = x1 },
      _1801: (x0,x1) => { x0.onchange = x1 },
      _1841: (x0,x1) => { x0.onerror = x1 },
      _2214: (x0,x1) => { x0.src = x1 },
      _2225: x0 => x0.width,
      _2227: x0 => x0.height,
      ...
      _3063: x0 => x0.width,
      _3064: (x0,x1) => { x0.width = x1 },
      _3065: x0 => x0.height,
      _3066: (x0,x1) => { x0.height = x1 },
      _3487: () => globalThis.window,
      _3814: x0 => x0.localStorage,
      _3990: x0 => x0.data,
      _4147: x0 => x0.length,
